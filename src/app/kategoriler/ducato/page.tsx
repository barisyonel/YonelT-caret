...
export default function DucatoPage() {
  const router = useRouter();
  const ducatoUrunler = products.filter(p => p.kategori.startsWith("Ducato"));
  return (
    <div className="flex flex-col gap-10 px-4 md:px-12">
      ...
      <section>
        <h2 className="text-2xl font-bold text-blue-800 mb-6">Ducato Ürünleri</h2>
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
          {ducatoUrunler.map((urun) => (
